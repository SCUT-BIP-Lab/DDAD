...
class Crowd_human:
    ...
    root_folder = '/home/data/CrowdHuman'
    image_folder = '/home/data/CrowdHuman/Images'
    train_source = os.path.join('/home/data/CrowdHuman/annotation_train.odgt')
    eval_source = os.path.join('/home/data/CrowdHuman/annotation_val.odgt')

class Config:
    output_dir = 'outputs'
    model_dir = os.path.join(output_dir, 'model_dump')
    eval_dir = os.path.join(output_dir, 'eval_dump')
    init_weights = '../Model_zoo/resnet50_fbaug.pth'
    ...
    momentum = 0.9
    weight_decay = 1e-4
    base_lr = 1e-5 * 1    #from 30 epoch change from 1 to 1.5
