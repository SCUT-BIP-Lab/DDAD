...
class RCNN(nn.Module):
    ...
    def forward(self, fpn_fms, rcnn_rois, labels=None, bbox_targets=None):
        ...
        if self.training:
            ...
            loss_dict = {}
            loss_dict['loss_rcnn_loc'] = loss_rcnn_loc*1.3
            loss_dict['loss_rcnn_cls'] = loss_rcnn_cls*1  
            return loss_dict
        else:
...
class Density(nn.Module):
    ...
    def forward(self, featrue, all_num=0, target=None, mask=None):
        ...
        if mask is not None:
            ...
            loss = self.criterion(density, target)
        loss_dict = {}
        loss_dict['loss_density'] = loss*0.00001
        loss_dict['loss_num'] = loss_num * 0.00001
        return loss_dict
